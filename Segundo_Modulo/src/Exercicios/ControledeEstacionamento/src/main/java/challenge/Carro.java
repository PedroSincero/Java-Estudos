...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        if(motorista == null) throw new EstacionamentoException("Invalid driver or empty filled fields");
        if(placa.isEmpty()) throw new EstacionamentoException("Invalid board or empty filled fields");
        if(cor == null) throw new EstacionamentoException("Invalid color or empty filled fields");
