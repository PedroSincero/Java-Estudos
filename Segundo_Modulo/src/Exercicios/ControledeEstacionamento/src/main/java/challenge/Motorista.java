...
//        if(nome.isEmpty()) throw new EstacionamentoException("Invalid or empty name");
        if(nome.length() == 0) throw new EstacionamentoException("Invalid or empty name");
        if(idade < 18) throw new EstacionamentoException("invalid age");
        if(pontos > 20) throw new EstacionamentoException("Points limit exceeded");
//        if(habilitacao.isEmpty()) throw new EstacionamentoException("Invalid or empty license");
        if(habilitacao.length() == 0) throw new EstacionamentoException("Invalid or empty license");
        this.nome = nome;
        this.idade = idade;
        this.pontos = pontos;
